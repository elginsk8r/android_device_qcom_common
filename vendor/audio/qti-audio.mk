...
QCOM_AUDIO_PATH := $(QCOM_SOONG_NAMESPACE)/audio/primary-hal
endif
QCOM_AUDIO_PATH ?= $(QCOM_SOONG_NAMESPACE)/audio

ifneq ($(filter sm6150,$(TARGET_BOARD_PLATFORM)),)
QCOM_AUDIO_CFG := msmsteppe
endif
QCOM_AUDIO_CFG ?= $(TARGET_BOARD_PLATFORM)

ifneq ($(filter $(QCOM_SOONG_NAMESPACE),$(PRODUCT_SOONG_NAMESPACES)),)
    -include $(QCOM_AUDIO_PATH)/configs/$(QCOM_AUDIO_CFG)/$(QCOM_AUDIO_CFG).mk
endif
